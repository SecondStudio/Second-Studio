...
//most of this was copied from procshape, so there remains a lot of unnecessary code for the hair
//some of this is because the radius and subsections of the hair will remain the same always while the shape can change
public class ProcHair : ProcBase
{  
    ...
    public int m_RadialSegmentCount = 12;
    ...
    public override Mesh BuildMesh()
    {
        ...
        for (int num = 0; num < controlPoints.Length - 1; ++num)
        {
            ...
            for (int i = 0; i <= m_LengthSegmentCount; i++)
            {
                ...
                BuildHair(meshBuilder, m_RadialSegmentCount, centrePos, radius, v, i > 0 || num > 0);
            }
        }
    ...
    protected void BuildHair(MeshBuilder meshBuilder, int segmentCount, Vector3 centre, float radius, float v, bool buildTriangles)
    {
